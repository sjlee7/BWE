...
flags.DEFINE_integer("batch_size", 256, "Batch size (Def: 150).")
flags.DEFINE_integer("save_freq", 100, "Batch save freq (Def: 50).")
flags.DEFINE_integer("canvas_size", 2**13, "Canvas size (Def: 2^13).")
...
flags.DEFINE_float("l1_weight", 0., "Init L1 lambda (Def: 100)")
...
flags.DEFINE_string("save_path", "asrgan_results", "Path to save out model "
                                                   "files. (Def: asrgan_results"
                                                   ").")
...
flags.DEFINE_string("tfrecords", "./data/train_multispeaker.tfrecords", "TFRecords"
                                                          " (Def: data/"
                                                          "asrgan.tfrecords.")
flags.DEFINE_string("tfrecords_val", "./data/valid_multispeaker.tfrecords", "TFRecords_val"
                                                          " (Def: data/"
                                                          "asrgan.tfrecords.")
